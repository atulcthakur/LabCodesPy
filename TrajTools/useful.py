...
### 90 K - Reading in the pickle and writing out a xyz. ####

aimd_90k = unpickle_object("90K_full_sorted.pkl")
xyz_writer(aimd_90k, atoms=None, xyzname="AIMD_90k_AAcocrystal.xyz", com_traj=False)
