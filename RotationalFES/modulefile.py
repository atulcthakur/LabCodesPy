...
def prepare_xyz_with_virtual_site(xyzname="Pos/Pos_90k.xyz", box=[18.284, 12.740, 11.778]):
    """
    ...
    virtual_xyz = add_virtual_site(wholed_xyz) # Adds in the virtual site on the acetyelene molecules.
